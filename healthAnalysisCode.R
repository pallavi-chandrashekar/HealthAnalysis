...
cleanDataSet2014 <- function(){
  survey <- read.csv("C:/Users/Mayank Phadke/Documents/College/DPA/HealthAnalysis/survey.csv",stringsAsFactors = F)
  ...
  write.csv(new_survey, "C:/Users/Mayank Phadke/Documents/College/DPA/HealthAnalysis/new_survey.csv", row.names = F)
  return(new_survey)
}
...
cleanDataSet2016 <- function(){
  # read the csv
  survey <- read.csv(
    "C:/Users/Mayank Phadke/Documents/College/DPA/HealthAnalysis/survey2016.csv",
    stringsAsFactors = F)
  ...
  write.csv(new_survey, "C:/Users/Mayank Phadke/Documents/College/DPA/HealthAnalysis/new_survey2016.csv", row.names = FALSE)
  return(new_survey)
}
...
new_survey2016 = whichPartOfWorldIsMostAffected()
#USA is most affected.


new_survey2016= reorderingData(new_survey2016)
listdata = divideData(new_survey2016)
print(paste("Data is divided as Train and Test :",nrow(listdata$train),",",nrow(listdata$test)))
